...
test('Eval Physics Formular u*t+\\frac{1}{2}a*t^2', () => {
  const answer = Substitution('u*t+\\frac{1}{2}a*t^2', { 
    u: '10.529314230564932',
    t: '3.468027260429826',
    a: '7.441272113817352' 
  })
...
test('Eval Physics Formular ut+\\frac{1}{2}at^2', () => {
  const answer = Substitution('ut+\\frac{1}{2}at^2', { 
    u: '10.529314230564932',
    t: '3.468027260429826',
    a: '7.441272113817352' 
  })
